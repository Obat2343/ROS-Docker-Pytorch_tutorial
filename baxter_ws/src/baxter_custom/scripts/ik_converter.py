...
class IKService:
    def __init__(self):
        rospy.init_node("ik_service_with_camera")
    ...
    with open(input_filename, 'r') as infile, open(output_filename, 'w') as outfile:
        ...
        for row in reader:
            ...
            if coordinate_origin == "base" and coordinate_system == "xyz":
                ...
                left_joint_angles = ik_service.uvz_transform_ik("left", left_position, left_orientation, input_frame=coordinate_origin)
                right_joint_angles = ik_service.uvz_transform_ik("right", right_position, right_orientation, input_frame=coordinate_origin)
            else:
